...
function Modal() {
  ...
  // Everytime movie changes, this will fetch the relevant video infomation
  useEffect(() => {
    if (!movie) return;
  ...
  return (
    <MuiModal
      open={showModal}
      onClose={handleClose}
      className="fixes !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden
